...
//Lista de Cidades em uma constante
const CIDADES = [  
  'osasco',
  'salvador',
  'paris',
...
function Ola () {  
  console.log('Olá Reprograma') //teste de funcionamento
}

app.listen(3000) //localhost

/* Nesse grande código, existem  funções dentro de funções, que dependem uma da outra, e que são programadas
para serem chamados posteriormente. Permitindo que tenha-se exemplo de Assincronicidade no código, e deste modo
